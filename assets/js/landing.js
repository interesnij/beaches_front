...
function switcherClick() {
  ...
  let lightThemeVar = lightBtn.addEventListener("click", () => {
    lightFn();
    localStorage.setItem("beachesHeader", "light");
    localStorage.setItem("beachesMenu", "light");
  });
  /* Light Layout End */
  ...
  let darkThemeVar = darkBtn.addEventListener("click", () => {
    darkFn();
    localStorage.setItem("beachesMenu", "dark");
    localStorage.setItem("beachesHeader", "dark");
  });
  /* Dark Layout End */
  ...
  let rtlVar = rtlBtn.addEventListener("click", () => {
    localStorage.setItem("beachesrtl", true);
    localStorage.removeItem("beachesltr");
    rtlFn();
  });
  /* rtl end */
  ...
  let ltrVar = ltrBtn.addEventListener("click", () => {
    //    local storage
    localStorage.setItem("beachesltr", true);
    localStorage.removeItem("beachesrtl");
    ltrFn();
  });
  /* ltr end */
...
function lightFn() {
  ...
  updateColors();
  localStorage.removeItem("beachesdarktheme");
  checkOptions();
  // html.style.removeProperty('--primary-rgb');
}
...
function darkFn() {
  ...
  updateColors();
  localStorage.setItem("beachesdarktheme", true);
  localStorage.removeItem("beacheslighttheme");
  checkOptions();
  // html.style.removeProperty("--primary-rgb");
}
...
function checkOptions() {
  ...
  //RTL
  if (localStorage.getItem("beachesrtl")) {
