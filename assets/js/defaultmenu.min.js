...
(() => {
  ...
  if (
    !localStorage.getItem("beacheslayout") &&
    !localStorage.getItem("beachesnavstyles") &&
    !localStorage.getItem("beachesverticalstyles") &&
      ...
      switch (verticalStyle) {
        ...
        case "overlay":
          ...
          if (html.getAttribute('data-toggled') === 'icon-overlay-close') {
            ...
            if (window.innerWidth >= 992) {
              if (!localStorage.getItem("beacheslayout")) {
