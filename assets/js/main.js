(function () {
    ...
    function localStorageBackup() {
        ...
        if (localStorage.beachesdarktheme) {
            let html = document.querySelector('html');
            html.setAttribute('data-theme-mode', 'dark');
        }
        if (localStorage.beacheslayout) {
            let html = document.querySelector('html');
            let layoutValue = localStorage.getItem('beacheslayout');
        ...
        if (localStorage.beachesverticalstyles) {
            let html = document.querySelector('html');
            let verticalStyles = localStorage.getItem('beachesverticalstyles');
            ...
            if (verticalStyles == 'closed') {
                ...
                localStorage.removeItem("beachesnavstyles")
            }
        ...
        if (localStorage.beachesnavstyles) {
            let html = document.querySelector('html');
            let navStyles = localStorage.getItem('beachesnavstyles');
            if (navStyles == 'menu-click') {
                html.setAttribute('data-nav-style', 'menu-click');
                localStorage.removeItem("beachesverticalstyles");
        ...
        if (localStorage.beachesclassic) {
            let html = document.querySelector('html');
            html.setAttribute('data-page-style', 'classic'); 
        }
        if (localStorage.beachesmodern) {
            let html = document.querySelector('html');
            html.setAttribute('data-page-style', 'modern');
        }
        if (localStorage.beachesboxed) {
            let html = document.querySelector('html');
            html.setAttribute('data-width', 'boxed');
        }
        if (localStorage.beachesHeaderfixed) {
            let html = document.querySelector('html');
            html.setAttribute('data-header-position', 'fixed');
        }
        if (localStorage.beachesHeaderscrollable) {
            let html = document.querySelector('html');
            html.setAttribute('data-header-position', 'scrollable');
        }
        if (localStorage.beachesMenufixed) {
            let html = document.querySelector('html');
            html.setAttribute('data-menu-position', 'fixed');
        }
        if (localStorage.beachesMenuscrollable) {
            let html = document.querySelector('html');
            html.setAttribute('data-menu-position', 'scrollable');
        }
        if (localStorage.beachesMenu) {
            let html = document.querySelector('html');
            let menuValue = localStorage.getItem('beachesMenu');
            switch (menuValue) {
                case 'light':
        ...
        if (localStorage.beachesHeader) {
            let html = document.querySelector('html');
            let headerValue = localStorage.getItem('beachesHeader');
            switch (headerValue) {
                case 'light':
