...
(function (SchemeDesigner) {
    ...
    var Layer = /** @class */ (function () {
        ...
        Layer.prototype.removeObject = function (object) {
            this.objects = this.objects.filter(function (existObject) { return existObject !== object; });
        };
        /**
         * Remove all objects
         */
...
(function (SchemeDesigner) {
    ...
    var SchemeObject = /** @class */ (function () {
         ...
         * @return null|boolean
         */
        SchemeObject.prototype.mouseDown = function (e, schemeDesigner, view) {
            if (typeof this.mouseDownFunction === 'function') {
                return this.mouseDownFunction(this, schemeDesigner, view, e);
            }
            return null;
        };
        /**
         * Mouse move with object
         * @param {MouseEvent} e
         * @param {Scheme} schemeDesigner
         * @param view
         * @return null|boolean
         */
        SchemeObject.prototype.mouseMove = function (e, schemeDesigner, view) {
            if (typeof this.mouseMoveFunction === 'function') {
                return this.mouseMoveFunction(this, schemeDesigner, view, e);
            }
            return null;
        };
        /**
         ...
         * @return null|boolean
         */
        SchemeObject.prototype.mouseUp = function (e, schemeDesigner, view) {
            if (typeof this.mouseUpFunction === 'function') {
                return this.mouseUpFunction(this, schemeDesigner, view, e);
            }
            return null;
        };
        /**
        ...
        /**
         * Set mouseDownFunction
         * @param {Function} value
         */
        SchemeObject.prototype.setMouseDownFunction = function (value) {
            this.mouseDownFunction = value;
        };
        /**
         * Set mouseMoveFunction
         * @param {Function} value
         */
        SchemeObject.prototype.setMouseMoveFunction = function (value) {
            this.mouseMoveFunction = value;
        };
        /**
         * Set mouseUpFunction
         * @param {Function} value
         */
        SchemeObject.prototype.setMouseUpFunction = function (value) {
            this.mouseUpFunction = value;
        };
        /**
         * Set clearFunction
         * @param {Function} value
...
(function (SchemeDesigner) {
    ...
    var EventManager = /** @class */ (function () {
        ...
        function EventManager(scheme) {
            ...
            this.objectMovingDelta = null;
            this.lockObjectMoving = false;
            /**
             * Left button down
             */
        ...
        EventManager.prototype.onMouseMove = function (e) {
            if (this.leftButtonDown) {
                ...
                if (!this.isDragging && (deltaX > 1 || deltaY > 1)) {
                    this.isDragging = true;
                    this.scheme.setCursorStyle('move');
                }
                else {
                    if (!this.isObjectMoving && !this.lockObjectMoving && (deltaX > 1 || deltaY > 1)) {
                        var objects = this.findObjectsForEvent(e);
                        for (var _i = 0, objects_2 = objects; _i < objects_2.length; _i++) {
                            var schemeObject = objects_2[_i];
                            schemeObject.mouseDown(e, this.scheme, this.scheme.getView());
                            this.objectMoving = schemeObject;
                            console.log("schemeObject", schemeObject);
                            var x = newCoordinates.x - this.scheme.getScrollManager().getScrollLeft();
                            var y = newCoordinates.y - this.scheme.getScrollManager().getScrollTop();
                            x = x / this.scheme.getZoomManager().getScale();
                            y = y / this.scheme.getZoomManager().getScale();
                            x = Math.abs(x - schemeObject.getX());
                            y = Math.abs(y - schemeObject.getY());
                            this.objectMovingDelta = { x: x, y: y };
                            this.scheme.addChangedObject(schemeObject);
                            this.sendEvent('mouseDownOnObject', schemeObject);
                            break;
                        }
                        if (objects.length) {
                ...
                if (!this.isObjectMoving) {
                    ...
                    x = x / this.scheme.getZoomManager().getScale();
                    y = y / this.scheme.getZoomManager().getScale();
                    this.objectMoving.setX(x - this.objectMovingDelta.x);
                    this.objectMoving.setY(y - this.objectMovingDelta.y);
                    this.sendEvent('mouseMoveOnObject', this.objectMoving);
                    this.scheme.requestRenderAll();
                    this.scheme.updateCache(true);
                }
            }
        ...
        EventManager.prototype.handleHover = function (e) {
            ...
            if (!this.hoveredObjects.length || hasNewHovers) {
                for (var _c = 0, objects_4 = objects; _c < objects_4.length; _c++) {
                    var schemeObject = objects_4[_c];
        ...
        EventManager.prototype.setLockObjectMoving = function (value) {
            this.lockObjectMoving = value;
        };
        return EventManager;
    }());
